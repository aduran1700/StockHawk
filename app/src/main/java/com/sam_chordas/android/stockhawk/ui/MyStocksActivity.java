        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        Cursor cursor = getContentResolver().query(QuoteProvider.Quotes.CONTENT_URI, null,
                                QuoteColumns._ID + "=" + mCursorAdapter.getItemId(position), null, null);

                        if (cursor != null) {
                            if (cursor.moveToFirst()) {
                                Quote quote = new Quote();
                                quote.symbol = cursor.getString(cursor.getColumnIndex(QuoteColumns.SYMBOL));
